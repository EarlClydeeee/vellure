        ...
        <div className="grid gap-4 md:grid-cols-3">
          {blogTeasers.map((post) => (
            <Link
              key={post.id}
              href={post.href}
              className="group cursor-pointer overflow-hidden rounded-2xl border border-slate-200 bg-white transition-colors duration-200 hover:border-vellure-primary/30 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-vellure-primary"
            >
